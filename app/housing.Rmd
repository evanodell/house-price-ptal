...
This map combines HM Land Registry's price paid data from September 2012 -- September 2017 inclusive with the [PTAL scores](https://data.london.gov.uk/dataset/public-transport-accessibility-levels) produced by TFL, which show how connected to public transport a given area is, in this case Lower Layer Super Output Areas (LSOA).
