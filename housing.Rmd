...
The bang for buck score is the 1 over the percentile of the estimated price-per-room ($\omega$), multiplied by the percentile of the PTAL score ($\tau$), divided by the inverse scaled (range of -1 to 0) price ($\rho$).
